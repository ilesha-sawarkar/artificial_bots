...
def Send_Link(name,pos, size, objectType,mass, rpy, material_name, rgba):
    ...
    if filetype == SDF_FILETYPE:
        ...
        link = LINK_URDF(name,pos,size, objectType, rpy, material_name, rgba)
...
def Send_Cube(name="default",pos=[0,0,0],size=[1,1,1], mass=1.0, rpy= "0 0 0", material_name="Cyan", rgba= "0 1.0 1.0 1.0"):
        
    Send_Link(name,pos,size,"box", mass, rpy,  material_name, rgba)
    
def Send_Sphere(name="default",pos=[0,0,0],size=[0.5], mass=1.0, rpy= "0 0 0", material_name="Cyan", rgba= "0 1.0 1.0 1.0"):
