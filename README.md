...
4. [Graphs & Hypothesis Conclusion](https://github.com/ilesha-sawarkar/artificial_bots/blob/3D-Creature_locomotion/README.md#4-graphs-chart_with_upwards_trend)
...
## 2. Experiments Performed
   ...
   2) Experimental
      ...
      * The Control Creature was built with a randomization of shapes and shape dimension lengths.
      * Moreover at each generation the Mutate function had a randomized option of either appending a link to the creatures, deleting a link or to not make any changes.
      * To maintain uniformity both the experiment and control were run on the same random seeds.
...
![Control](https://user-images.githubusercontent.com/114837040/225230628-96483f28-6833-42e4-9bf6-7589cc2c885b.png)

### Graph for Experimental Creature with Prismatic Joints
![Experiment](https://user-images.githubusercontent.com/114837040/225230843-f5d932f2-6a64-42ff-882d-24aade68e5cc.png)

* These graphs were generated by running analyze.py
* We can see from the graph that revolute joint move slower than prismatic thus proving the above hypothesis

#### Hypothesis Conclusion
   * Hypothesis is confirmed **Prismatic Joints help the creature run faster than revolute joints**
