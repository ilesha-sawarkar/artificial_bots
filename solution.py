    ...
    def Create_Body(self):
        ...
        for i in range(0,number_of_links):
            ...
            if(i == 0):
                ...
                if (linkToJoin == "Link0"):
                    if (jointPositionAxis == 0):
                        pyrosim.Send_Joint(name = linkToJoin + "_" + "Link" + str(i) , parent = linkToJoin , child = "Link" + str(i) , type = "revolute", position = [self.shapeInfo[linkToJoin][0], self.shapeInfo[linkToJoin][1]/2, self.shapeInfo[linkToJoin][2]/2], jointAxis = "1 0 0")
                        ...
                        pyrosim.Send_Joint(name = linkToJoin + "_" + "Link" + str(i) , parent = linkToJoin , child = "Link" + str(i) , type = "revolute", position = [self.shapeInfo[linkToJoin][0]/2, self.shapeInfo[linkToJoin][1]/2, self.shapeInfo[linkToJoin][2]], jointAxis = "0 0 1")
                        self.motorNeurons.append(linkToJoin + "_" + "Link" + str(i))
                    
                elif(grandParAxis == jointPositionAxis):
                    if (jointPositionAxis == 0):
                        pyrosim.Send_Joint(name = linkToJoin + "_" + "Link" + str(i) , parent = linkToJoin , child = "Link" + str(i) , type = "revolute", position = [self.shapeInfo[linkToJoin][0],0,0], jointAxis = "1 0 0")
                        self.motorNeurons.append(linkToJoin + "_" + "Link" + str(i))
                    elif (jointPositionAxis == 1):
                        pyrosim.Send_Joint(name = linkToJoin + "_" + "Link" + str(i) , parent = linkToJoin , child = "Link" + str(i) , type = "revolute", position = [0,self.shapeInfo[linkToJoin][1],0], jointAxis = "0 1 0")
                        self.motorNeurons.append(linkToJoin + "_" + "Link" + str(i))
                    else:
                        pyrosim.Send_Joint(name = linkToJoin + "_" + "Link" + str(i) , parent = linkToJoin  , child = "Link" + str(i) , type = "revolute", position = [0,0,self.shapeInfo[linkToJoin][2]], jointAxis = "0 0 1")
                        self.motorNeurons.append(linkToJoin + "_" + "Link" + str(i))
                
                else:
                    if (grandParAxis == 0):
                        if (jointPositionAxis == 1):
                            pyrosim.Send_Joint(name = linkToJoin + "_" + "Link" + str(i) , parent = linkToJoin , child = "Link" + str(i) , type = "revolute", position = [self.shapeInfo[linkToJoin][0]/2, self.shapeInfo[linkToJoin][1]/2, 0], jointAxis = "0 1 0")
                            self.motorNeurons.append(linkToJoin + "_" + "Link" + str(i))
                        else:
                            pyrosim.Send_Joint(name = linkToJoin + "_" + "Link" + str(i) , parent = linkToJoin  , child = "Link" + str(i) , type = "revolute", position = [self.shapeInfo[linkToJoin][0]/2, 0, self.shapeInfo[linkToJoin][2]/2], jointAxis = "0 0 1")
                            self.motorNeurons.append(linkToJoin + "_" + "Link" + str(i))
                    elif (grandParAxis == 1):
                        if (jointPositionAxis == 0):
                            pyrosim.Send_Joint(name = linkToJoin + "_" + "Link" + str(i) , parent = linkToJoin , child = "Link" + str(i) , type = "revolute", position = [self.shapeInfo[linkToJoin][0]/2, self.shapeInfo[linkToJoin][1]/2, 0], jointAxis = "1 0 0")
                            self.motorNeurons.append(linkToJoin + "_" + "Link" + str(i))
                        else:
                            pyrosim.Send_Joint(name = linkToJoin + "_" + "Link" + str(i) , parent = linkToJoin  , child = "Link" + str(i) , type = "revolute", position = [0, self.shapeInfo[linkToJoin][1]/2, self.shapeInfo[linkToJoin][2]/2], jointAxis = "0 0 1")
                            self.motorNeurons.append(linkToJoin + "_" + "Link" + str(i))
                    else:
                        if (jointPositionAxis == 0):
